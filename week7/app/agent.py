...
app = FastAPI(title="TechCorp Agent API", version="3.0.0")
...
# Mount feedback endpoints: POST /feedback, GET /feedback/stats
...
async def query_agent(request: QueryRequest):
    ...
    # 9. Record metrics (week 7: also pass cost and token count)
    mon.record_query(
        role=request.user_role,
        latency_ms=latency_ms,
        docs_retrieved=docs_retrieved,
